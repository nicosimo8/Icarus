...
# containers create
sudo docker create -p3306:3306 --name icarusdb --network icarusnet -e MYSQL_ROOT_PASSWORD=Dedalus.1234 -e MYSQL_USER=dedalus -e MYSQL_PASSWORD=dedalus1234 -e MYSQL_DATABASE=icaro mysql -v icaro-data:/var/lib/mysql
